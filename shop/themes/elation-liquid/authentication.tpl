		...
		<fieldset>
			...
			<div class="form_content clearfix">
				...
				<p class="text">
					...
					<span><input type="Email" id="email_create" name="email_create" value="{if isset($smarty.post.email_create)}{$smarty.post.email_create|escape:'htmlall':'UTF-8'|stripslashes}{/if}" class="account_input" /></span>
				</p>
				<p class="submit">
				...
				<div id="opc_account_form" style="display: block; ">
					...
					{foreach from=$dlv_all_fields item=field_name}
						...
						<p class="required text">
							...
							<input type="number" class="text" name="phone" id="phone" value="{if isset($smarty.post.phone)}{$smarty.post.phone}{/if}">
						</p>
						{/if}
					{/foreach}
...
<form action="{$link->getPageLink('authentication.php', true)}" method="post" id="account-creation_form" class="std">
	...
	<fieldset class="account_creation">
		...
		<p class="text">
			...
			<input type="number" class="text" name="phone_mobile" id="phone_mobile" value="{if isset($smarty.post.phone_mobile)}{$smarty.post.phone_mobile}{/if}" />
