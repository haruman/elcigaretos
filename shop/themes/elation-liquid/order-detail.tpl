...
<ul class="detail-address alternate_item" {if $order->isVirtual()}style="display:none;"{/if}>
							...
							{foreach from=$customization.datas key='type' item='datas'}
								...
								<ul class="customizationUploaded">
									{foreach from=$datas item='data'}
										<li><img src="{$pic_dir}{$data.value}_small_liquid" alt="" class="customizationUploaded" /></li>
									{/foreach}
								</ul>
